...
import EmailConfirmModal from '../components/common/EmailConfirmModal';
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  {usernameLoading || username === '' ? (
                    <DotsCircleHorizontalIcon
                      className={`h-5 w-5 text-gray-400 ${usernameLoading && 'animate-spin'
                        }`}
                      aria-hidden="true"
                    />
                ...
                <input
                  ...
                  name="username"
                  id="username"
                  className={`focus:ring-pink-500 focus:border-pink-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md ${username !== '' && !usernameAvailable ? 'bg-red-100' : ''
                    }`}
