...
const ProfileSettings = ({ profile }) => {
    ...
    const [techStack, setTechStack] = useState(() => profile.techStack.join(','));
    ...
    const { github, instagram, linkedin, twitter, website, youtube } = social
    ...
    const handleTechStack = useCallback((e) => setTechStack(e.target.value), [])
